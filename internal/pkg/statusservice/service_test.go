...
func TestStartWebServer_Fail(t *testing.T) {
	err := StartWebServer(t.Context(), &Data{})
	assert.NotNil(t, err)
}
...
func Test_Returns(t *testing.T) {
	initTest(t)
	pegomock.When(providerMock.Get(pegomock.Any[context.Context](), pegomock.Any[string]())).ThenReturn(&persistence.Status{ID: "10", Status: "olia"}, nil)
	...
	_, mID := providerMock.VerifyWasCalled(pegomock.Once()).Get(pegomock.Any[context.Context](), pegomock.Any[string]()).GetCapturedArguments()
	assert.Equal(t, "10", mID)
}

func Test_Returns_Error(t *testing.T) {
	initTest(t)
	pegomock.When(providerMock.Get(pegomock.Any[context.Context](), pegomock.Any[string]())).ThenReturn(&persistence.Status{ID: "10", Status: "olia", Error: "err"}, nil)
	req := httptest.NewRequest(http.MethodGet, "/status/10", nil)
	resp := testCode(t, req, 200)
	bytes, _ := io.ReadAll(resp.Body)
...
func Test_Fails(t *testing.T) {
	initTest(t)
	pegomock.When(providerMock.Get(pegomock.Any[context.Context](), pegomock.Any[string]())).ThenReturn(nil, errors.New("olia"))
	req := httptest.NewRequest(http.MethodGet, "/status/10", nil)
	testCode(t, req, 500)
}
...
func Test_Fails_NoStatus(t *testing.T) {
	initTest(t)
	pegomock.When(providerMock.Get(pegomock.Any[context.Context](), pegomock.Any[string]())).ThenReturn(nil, nil)
	req := httptest.NewRequest(http.MethodGet, "/status/10", nil)
	testCode(t, req, 400)
}
