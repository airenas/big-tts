...
func Test_saveToSSMLString(t *testing.T) {
	tests := []struct {
		...
		{name: "Text", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}}}}, want: "<speak>olia</speak>"},
		{name: "Voice", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}}, Voice: "as"}},
			want: `<speak><voice name="as">olia</voice></speak>`},
		{name: "Break", args: []ssml.Part{&ssml.Pause{Duration: 4 * time.Second}},
			want: `<speak><break time="4000ms"/></speak>`},
		{name: "Several", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}}, Voice: "as"},
			&ssml.Pause{Duration: 2 * time.Second},
			&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}}, Voice: "as2"}},
			want: `<speak><voice name="as">olia</voice>` +
				`<break time="2000ms"/>` +
		...
		{name: "Prosody", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}},
			...
			want: `<speak><prosody rate="200%" volume="-2.40dB" pitch="-6.00st">olia</prosody></speak>`},
		{name: "Prosody", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}},
			Prosodies: []*ssml.Prosody{{Rate: 0.5, Volume: -2.4, Pitch: ssml.PitchChange{Kind: ssml.PitchChangeMultiplier, Value: 1.5}}}}},
			want: `<speak><prosody rate="200%" volume="-2.40dB" pitch="+50.00%">olia</prosody></speak>`},
		{name: "Prosody", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}},
			Prosodies: []*ssml.Prosody{{Rate: 0.5, Volume: -2.4, Pitch: ssml.PitchChange{Kind: ssml.PitchChangeMultiplier, Value: 0.5}}}}},
			want: `<speak><prosody rate="200%" volume="-2.40dB" pitch="-50.00%">olia</prosody></speak>`},
		{name: "Prosody several", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}},
			Prosodies: []*ssml.Prosody{{Rate: 0.5, Volume: -2.4, Pitch: ssml.PitchChange{Kind: ssml.PitchChangeMultiplier, Value: 0.5}},
				{Rate: 1, Volume: -1000, Pitch: ssml.PitchChange{Kind: ssml.PitchChangeHertz, Value: -5}}}}},
			want: `<speak><prosody rate="200%" volume="-2.40dB" pitch="-50.00%"><prosody rate="100%" volume="silent" pitch="-5.00Hz">olia</prosody></prosody></speak>`},
		{name: "Emphasis", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia"}},
			Prosodies: []*ssml.Prosody{{Emphasis: ssml.EmphasisTypeStrong}}}},
			want: `<speak><emphasis level="strong">olia</emphasis></speak>`},
		...
		{name: "Several words", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "before"}, {Text: "olia", Accented: "oli{a/}"}, {Text: "long end"}},
		...
		{name: "Word sylls", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia", Accented: "oli{a/}", Syllables: "o-li-a"}},
			Prosodies: []*ssml.Prosody{{Rate: 1}}, Voice: "as"}},
			want: `<speak><voice name="as"><prosody rate="100%"><intelektika:w acc="oli{a/}" syll="o-li-a">olia</intelektika:w></prosody></voice></speak>`},
		{name: "Word OE model", args: []ssml.Part{&ssml.Text{Texts: []ssml.TextPart{{Text: "olia", Accented: "oli{a/}", Syllables: "o-li-a", UserOEPal: "O'lia"}},
			Prosodies: []*ssml.Prosody{{Rate: 1}}, Voice: "as"}},
...
func TestWorker_doSSML(t *testing.T) {
	tests := []struct {
		...
		{name: "do not split at word tag", wChars: 30, args: `<speak>laba diena <intelektika:w acc="oli{a/}" syll="o-l-ia" user="O'li*a">olia</intelektika:w> laba diena. laba diena laba diena</speak>`,
			want: []string{`<speak><voice name="vd">laba diena<intelektika:w acc="oli{a/}" syll="o-l-ia" user="O&#39;li*a">olia</intelektika:w>laba diena.</voice></speak>`,
				`<speak><voice name="vd">laba diena laba diena</voice></speak>`},
			wantErr: false},
		...
		{name: "splits many words", wChars: 20, args: `<speak><intelektika:w acc="dfasdf{a/}">asdfg</intelektika:w><intelektika:w acc="dfasdf{a/}">asdfg</intelektika:w>` +
			...
			want: []string{`<speak><voice name="vd"><intelektika:w acc="dfasdf{a/}">asdfg</intelektika:w>` +
				`<intelektika:w acc="dfasdf{a/}">asdfg</intelektika:w></voice></speak>`,
				`<speak><voice name="vd"><intelektika:w acc="dfasdf{a/}">asdfg</intelektika:w>` +
					`<intelektika:w acc="dfasdf{a/}">asdfg</intelektika:w></voice></speak>`},
			wantErr: false},
		{name: "splits with words", wChars: 20, args: `<speak><intelektika:w acc="asdfasdf{a/}">asdfgasdfg</intelektika:w>0123456789 0123456789</speak>`,
			want: []string{`<speak><voice name="vd"><intelektika:w acc="asdfasdf{a/}">asdfgasdfg</intelektika:w>0123456789</voice></speak>`,
				`<speak><voice name="vd">0123456789</voice></speak>`},
			wantErr: false},
		{name: "splits", wChars: 20, args: "<speak>0123456789 0123456789 0123456789</speak>",
			want: []string{`<speak><voice name="vd">0123456789 0123456789</voice></speak>`,
				`<speak><voice name="vd">0123456789</voice></speak>`},
			wantErr: false},
		{name: "splits unicode", wChars: 20, args: "<speak>ąčęėįšųūŽŽ ąčęėįšųūŽŽ ąčęėįšųūŽŽ</speak>",
			want: []string{`<speak><voice name="vd">ąčęėįšųūŽŽ ąčęėįšųūŽŽ</voice></speak>`,
				`<speak><voice name="vd">ąčęėįšųūŽŽ</voice></speak>`},
			wantErr: false},
		{name: "splits unicode full", wChars: 20, args: "<speak>ąčęėįšųūŽŽąčęėįšųūŽŽ ąčęėįšųūŽŽ</speak>",
			want: []string{`<speak><voice name="vd">ąčęėįšųūŽŽąčęėįšųūŽŽ</voice></speak>`,
				`<speak><voice name="vd">ąčęėįšųūŽŽ</voice></speak>`},
			wantErr: false},
		{name: "no text", wChars: 20, args: "", want: nil, wantErr: true},
		{name: "no split", wChars: 20, args: "<speak>olia</speak>",
			want:    []string{`<speak><voice name="vd">olia</voice></speak>`},
			wantErr: false},
		{name: "add break", wChars: 20, args: "<speak>0123456789 0123456789 0123456789<p/></speak>",
			want: []string{`<speak><voice name="vd">0123456789 0123456789</voice></speak>`,
				`<speak><voice name="vd">0123456789</voice><break time="1250ms"/></speak>`},
			wantErr: false},
		...
		<voice name="oovd"><prosody rate="x-slow">0123456789</prosody></voice></speak>`,
			want: []string{`<speak><voice name="vd">0123456789 0123456789</voice>` +
		...
		<voice name="oovd"><prosody rate="x-slow"><intelektika:w acc="oli{a/}a">olia2</intelektika:w></prosody></voice></speak>`,
			want: []string{`<speak><voice name="vd"><intelektika:w acc="oli{a/}">olia</intelektika:w></voice>` +
		...
		{name: "parse sylls OEmodel", wChars: 1000, args: `<speak><intelektika:w acc="oli{a/}" syll="o-l-ia" user="O'li*a">olia</intelektika:w></speak>`,
			want:    []string{`<speak><voice name="vd"><intelektika:w acc="oli{a/}" syll="o-l-ia" user="O&#39;li*a">olia</intelektika:w></voice></speak>`},
			wantErr: false},
		{name: "splits many words", wChars: 20, args: `<speak lang="en">asdfg asdfg ` +
			`asdfg asdfg asdfg</speak>`,
